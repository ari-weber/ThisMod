...
{
	public class DragonFlailProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "ThisMod/Items/Weapons/Melee/DragonFlail/DragonFlailProjectileChain";
