...
{
	public class IcyDragonFlailProjectile : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "ThisMod/Items/Weapons/Meelee/DragonFlail/IcyDragonFlailProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Dragon Flail Ball"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void AI()
		{
			...
			else if (projectile.ai[0] == 1f)
			{
				...
				float maxStretchLength = 290f; // This is the furthest the flail can stretch before being forced to retract. Make sure that this is a bit less than maxChainLength so you don't accidentally reach maxStretchLength on the initial throw.
