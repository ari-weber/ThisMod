...
namespace ThisMod.Items.Weapons.Ranged.Bows
{
	public class IcyScaleBow : ModItem
	{
		...
		// What if I wanted this gun to have a 8% chance not to consume ammo?
		public override bool ConsumeAmmo(Player player)
		{
			return Main.rand.NextFloat() >= .08f;
		}
