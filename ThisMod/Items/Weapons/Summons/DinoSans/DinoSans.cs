...
{
	public class DinoSansBuff : ModBuff
	{
		public override void SetDefaults()
		{
			DisplayName.SetDefault("Dino Sans");
			Description.SetDefault("Better with trombone.");
		...
		{
			if (player.ownedProjectileCounts[mod.ProjectileType("DinoSans")] > 0)
			{
	...
	public class DinoSans : ModProjectile
	{
		...
		private const int fullBrightTicks = 500;
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(BuffType<DinoSansBuff>());
			}
			if (player.HasBuff(BuffType<DinoSansBuff>()))
			{
